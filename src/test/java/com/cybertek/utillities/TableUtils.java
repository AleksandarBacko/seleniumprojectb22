...
public class TableUtils {
    ...
    public static void printNamesAndEmails(WebDriver driver){
        List<WebElement > allNames=driver.findElements(By.xpath("//table[@id='table1']//tbody/tr/td[2]"));
        List<WebElement > allEmails=driver.findElements(By.xpath("//table[@id='table1']//tbody/tr/td[3]"));

        for (int i = 0; i < allNames.size(); i++) {
            System.out.println("Name"+(i+1)+": "+allNames.get(i).getText()+",Email"+(i+1)+": "+allEmails.get(i).getText());
